...
| [Getting Started](https://apps.dev.microsoft.com/portal/register-app)| [Documentation](https://aka.ms/aaddev) | [API Reference](http://cocoadocs.org/docsets/MSAL/) | [Support](README.md#community-help-and-support)
| --- | --- | --- | --- |
